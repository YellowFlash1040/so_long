...
A small 2D game built in C using the MLX library
 where the player navigates through a map collecting items and reaching the exit.

This project is part of the 42 School curriculum and demonstrates proficiency in C programming, using graphics libraries, and handling user input.
